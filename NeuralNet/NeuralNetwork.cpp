...
NeuralNetwork::NeuralNetwork(vector<int> top, double bias, double learnRate)
{
	...
	{
		Matrix* m = new Matrix(topology.at(i), topology.at(i + 1), true); //generacja losowych warto�ci wag
...
void NeuralNetwork::BackPropagation()
{
	...
	//policzenie wektora gradient�w warstw output i ostatniej hidden G = Z' * E ; E = (y - yHat)
	...
	for (int i = (outputLayerIndex - 1); i > 0; i--)
	{
		...
		//policzenie r�nicy (jak w kroku 1)
